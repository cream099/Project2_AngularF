...
export class CallserviceService {
  ...
  // uploadProfileImage(data : any, userId : any) : Observable<any> {
  //   const body = JSON.stringify(data);
  //   return this.http.put<any>(API_ENDPOINT.concat('/imguser/update/'+ userId), body, httpOptions)
  // }
  ...
  saveProfile(data : FormData) : Observable<any> {
    const body = JSON.stringify(data);
    return this.http.post<any>(API_ENDPOINT.concat('/imguser/save'), data)
  }
  ...
  getByOrderId(ordersId: any): Observable<any> {
    return this.http.get(
      API_ENDPOINT.concat('/order/getById?ordersId=' + ordersId)
    );
  }

  // userImage() : Observable<any> {
  //   return this.http.get<any>(API_ENDPOINT.concat('/imguser/getAll'))
  // }
